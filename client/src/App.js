  ...
  return (
    <div>
      ...
      <Routes>
        ...
        {/* <Route element = {<PrivateRoutes isLogged={isLogged} user={user}/>}>
          <Route element={<ViewAllMeds/>} path="/formulary" exact/>
        </Route> */}
        {/* {(user) ? <Route element = {<InventoryMeds isLogged={isLogged} setIsLogged={setIsLogged} user={user} setUser={setUser}/>} path="/formulary/inventory" />
        : navigate ("/login") } */}
